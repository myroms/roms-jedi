...
# define RI_SPLINES
#endif
#define LIMIT_VDIFF       /* Limits vertical diffusion high values */
#define LIMIT_VVISC       /* Limits vertical vicosity high values *
...
#define CHECKSUM          /* Activates checksum statitics */
#undef  DEBUGGING         /* Removes some header attributes in output files */
#undef  POSITIVE_ZERO
#undef  ROMS_STDOUT       /* Standard output is written in "log.roms" */

#undef  COLLECT_ALLREDUCE
#undef  REDUCE_ALLGATHER
...
/*
**  Options for the roms-jedi interface.
*/
