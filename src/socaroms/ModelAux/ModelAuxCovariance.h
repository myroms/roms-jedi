...
#ifndef SOCAROMS_MODELAUX_MODELAUXCOVARIANCE_H_
#define SOCAROMS_MODELAUX_MODELAUXCOVARIANCE_H_
...
class ModelAuxCovariance : public util::Printable,
 ...
 public:
  static const std::string classname() {return "socaroms::ModelBiasCovariance";}
...
#endif  // SOCAROMS_MODELAUX_MODELAUXCOVARIANCE_H_
