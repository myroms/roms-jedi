...
#ifndef SOCAROMS_MODELAUX_MODELAUXINCREMENT_H_
#define SOCAROMS_MODELAUX_MODELAUXINCREMENT_H_
...
namespace socaroms {
  ...
  class ModelAuxIncrement : public util::Printable,
   ...
   public:
    static const std::string classname() {return "socaroms::ModelAuxIncrement";}
...
#endif  // SOCAROMS_MODELAUX_MODELAUXINCREMENT_H_
