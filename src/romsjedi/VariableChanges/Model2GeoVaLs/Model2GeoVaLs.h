...
#ifndef ROMSJEDI_VARIABLECHANGES_MODEL2GEOVALS_MODEL2GEOVALS_H_
#define ROMSJEDI_VARIABLECHANGES_MODEL2GEOVALS_MODEL2GEOVALS_H_
...
namespace romsjedi {
  ...
  class Model2GeoVaLs: public oops::VariableChangeBase<Traits> {
   public:
    static const std::string classname() {return "roms::Model2GeoVaLs";}
...
#endif  // ROMSJEDI_VARIABLECHANGES_MODEL2GEOVALS_MODEL2GEOVALS_H_
