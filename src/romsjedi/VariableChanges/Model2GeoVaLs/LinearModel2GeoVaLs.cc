...
#include "romsjedi/VariableChanges/Model2GeoVaLs/Model2GeoVaLsFortran.h"
...
// -----------------------------------------------------------------------------
  ...
  void LinearModel2GeoVaLs::multiply(const Increment &dxin,
    ...
    roms_model2geovals_linear_changevar_f90(geom_->toFortran(),
                                            dxin.toFortran(),
                                            dxout.toFortran());
  }
...
// -----------------------------------------------------------------------------
  ...
  void LinearModel2GeoVaLs::multiplyAD(const Increment &dxin,
                                             Increment &dxout) const {
    roms_model2geovals_linear_changevarAD_f90(geom_->toFortran(),
                                              dxin.toFortran(),
                                              dxout.toFortran());
  }
