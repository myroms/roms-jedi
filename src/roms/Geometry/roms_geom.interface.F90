...
SUBROUTINE c_roms_geo_info (c_key_self, nx, ny, nz, tile,                    &
                            LBi, UBi, LBj, UBj,                              &
                            Istr, Iend, Jstr, Jend)                          &
...
SUBROUTINE c_roms_geo_get_num_levels (c_key_self, c_vars,                    &
                                      c_levels_size, c_levels)               &
                                BIND (c, name='roms_geo_get_num_levels_f90')
...
END SUBROUTINE c_roms_geo_get_num_levels
